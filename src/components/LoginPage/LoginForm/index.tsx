            ...
            <Space direction="vertical" className="input-group">
              ...
              <Controller
                render={({ field }) => (
                  <Input.Password
                    {...field}
                    onInput={(value) => removeSpaces(value.currentTarget)}
              ...
              />
              {errors.password && (
                <Text type="danger" className="w-1/2 flex-wrap">
                  {errors.password.message}
                </Text>
              )}
            </Space>
            <Button
              className="bg-white text-blue-400 border-blue-400 rounded"
              type="primary"
              htmlType="submit"
              loading={isFetch && loadings[0]}
